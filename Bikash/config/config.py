...
OWNER_ID = list(map(int, getenv("OWNER_ID", None).))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/cutexboy/VSCSUPPORTBABY")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/The_F2F_Shayri")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/FRIENDS2FAMILY_0")
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/fab30cd0fa5f39e87b4c1.jpg")
