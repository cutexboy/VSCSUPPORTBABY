    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("The_F2F_Shayri")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("The_F2F_Shayri")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("The_F2F_Shayri")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("The_F2F_Shayri")
            except:
                pass
            assistants.append(5)
